...
class Character : public Goldbox::Data::Character {
    ...
    Goldbox::Data::Stat strength;                   // Offset: 0x10, Length: 1 byte
    Goldbox::Data::Stat intelligence;               // Offset: 0x11, Length: 1 byte
    Goldbox::Data::Stat wisdom;                     // Offset: 0x12, Length: 1 byte
    Goldbox::Data::Stat dexterity;                  // Offset: 0x13, Length: 1 byte
    Goldbox::Data::Stat constitution;               // Offset: 0x14, Length: 1 byte
    Goldbox::Data::Stat charisma;                   // Offset: 0x15, Length: 1 byte
    Goldbox::Data::Stat ext_strength;               // Offset: 0x16, Length: 1 byte
    char memorized_spells[22];                      // Offset: 0x17, Length: 22 bytes
    Goldbox::Data::CombatStat thac0;                // Offset: 0x2D, Length: 1 byte, Default: 40
    uint8 race;                                     // Offset: 0x2E, Length: 1 byte
    uint8 class_type;                               // Offset: 0x2F, Length: 1 byte
    uint16 age;                                     // Offset: 0x30, Length: 2 bytes
    Goldbox::Data::Stat hit_points;                 // Offset: 0x32, Length: 1 byte
    ...
    Goldbox::Data::CombatStat armor_class;          // Offset: 0xA9, Length: 1 byte, Default: 50
    ...
    Goldbox::Data::CombatStat ac_for_rear_attacks;  // Offset: 0x112, Length: 1 byte
