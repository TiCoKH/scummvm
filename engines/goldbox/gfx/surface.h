...
public:
	...
	void writeSymbol(unsigned char s_id, uint32 bgColor, uint32 tpColorIndex = 0);
	void writeSymbol(unsigned char s_id, int x, int y, uint32 bgColor, uint32 tpColorIndex = 0);
